...
public class PersonaController {
    ...
    @GetMapping("/dni/{nDocumento}")
    public ResponseEntity<?> findByPersonaBynDocumento(@PathVariable String nDocumento){   
      PersonaResponse personaResponse;
        try {  
        ...
        if (personaResponse==null) {    
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ErrorResponse.builder().message(" Not found").build());
        }
